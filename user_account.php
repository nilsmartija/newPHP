  ...
  <div class="row">
    <div class="col-md-12">
      <div class="profile-info">
        ...
        <div class="info-body">
          <p><strong>First Name:</strong> Kayel</p>
          <p><strong>Last Name:</strong> Latayan</p>
          <p><strong>Birthday:</strong> July 22, 2003</p>
        </div>
      </div>
    </div>
    </div>
    ...
    <div class="col-md-12">
      <div class="address-info">
        ...
        <div class="info-body">
          <p><strong>Street:</strong> Sitio bauan</p>
          <p><strong>Barangay:</strong> Quilo-quilo south</p>
          <p><strong>City:</strong> Padre Garcia </p>
          <p><strong>Province:</strong> Batangas</p>
